-- =============================================================================
-- Puente isp_management.olts  →  ispm_tkc.tkc_families  (REFERENCIA BLANDA)
-- Correr EN isp_management (NO en ispm_tkc).
...
-- la referencia; el valor es ispm_tkc.tkc_families.id.
-- =============================================================================
